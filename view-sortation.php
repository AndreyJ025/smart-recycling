          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              <div class="card bg-light mb-3" style="max-width: 20rem;">
                <div class="card-header"><?= strtoupper($row["name"]); ?></div>
                <div class="card-body">
                  <!-- <h4 class="card-title">Light card title</h4> -->
                  <p class="card-text text-bold"><?= $row["address"]; ?></p>
                  <p class="card-text text-bold"><?= $row["description"]; ?></p>

                  <br/>
                  <a href="<?= strtoupper($row["link"]); ?>"><button class="btn btn-success">Visit Link</button></a>
                </div>
              </div>
              <?php
            }
